...
async function sendResetEmail(to: string, actionLink: string) {
  ...
  const { error } = await resend.emails.send({
    ...
    html: `<!DOCTYPE html><html lang="nb"><body style="font-family:sans-serif;line-height:1.6;color:#1f2937;">
      ...
      <p><a href="${actionLink}" style="display:inline-block;background:#1c4b9b;color:#fff;padding:12px 22px;border-radius:8px;text-decoration:none;font-weight:600;">Velg nytt passord</a></p>
